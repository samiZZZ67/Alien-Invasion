...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        pygame.display.set_caption('Alien Invasion ---SAMIS---')
    ...
    def _start_game(self):
        """RESPOND TO KESPACE P TO START THE GAME."""
    ...
    def _fire_bullet(self):
        """Create an ew abullet and add it to the bullets group."""
    ...
    def _create_fleet(self):
        ...
        #available_space_y=(self.settings.screen_height -(2* alien_height))//2
